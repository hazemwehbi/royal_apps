            ...
            <tr v-for="author in authors.data" :key="author.id">
                ...
                <td>
                    <div class="btn-group" role="group">
                        <router-link :to="{name: 'author_edit', params: { id: author.id }}" class="btn btn-success">Edit
                        </router-link>
                         <router-link :to="{name: 'book', params: { id: author.id }}" class="btn btn-primary">Books
                        </router-link>
    ...
    export default {
        ...
        methods: {
            ...
            deleteAuthor(id) {
                ...
                if(this.authors.data.find(x=>x.id === id).books.length==0){
                ...
                this.$toastr.e("This Author Has Book, You Cant Remove");
            },
