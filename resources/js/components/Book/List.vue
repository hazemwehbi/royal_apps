<template>
    <div>
        ...
        <div class="card">
            <div class="card-header"><router-link class="float-right btn btn-success btn-sm add-book" :to="{name: 'book_add'}"><i class="fa fa-fw fa-plus-circle"></i> Add Book</router-link></div>
            <div class="card-body">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                <input type="text" v-model="search" v-on:keyup.enter="searchBook" class="form-control" value="" placeholder="Search" name="search">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th @click="sort('subject')">Subject <i class="fa fa-sort" aria-hidden="true"></i></th>
                  <th @click="sort('version_date')">Version Date <i class="fa fa-sort" aria-hidden="true"></i></th>
                   <th @click="sort('serial_number')">Serial Number <i class="fa fa-sort" aria-hidden="true"></i></th>
            ...
            <tr v-for="book in books.data" :key="book.id">
                ...
                <td>
                    <div class="btn-group" role="group">
                        <router-link :to="{name: 'book_edit', params: { id: book.id }}" class="btn btn-success">Edit
                        </router-link>
                        <router-link :to="{name: 'profile', params: { id: book.id }}" class="btn btn-primary">Profile
                        </router-link>
            ...
            list(page) {
                ...
                this.axios
                    ...
                    .then(response => {
                        ...
                        this.$router.replace({ name: "book", query: {search: this.search, order_by: this.currentSort, sort: this.currentSortDir, page: this.page,auth_id: this.auth_id} });
                    });
            },
            deleteBook(id) {
